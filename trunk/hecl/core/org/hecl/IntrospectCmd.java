...
/**
 * <code>IntrospectCmd</code> implements the "intro" command, providing
 * different ways of examining the state of the Hecl interpreter.
 * 
...
class IntrospectCmd implements Command {
    ...
    public void cmdCode(Interp interp, Thing[] argv) throws HeclException {
        String subcmd = argv[1].getStringRep();

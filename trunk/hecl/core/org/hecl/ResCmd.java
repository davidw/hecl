 ...
 * @version 1.0
 */
class ResCmd implements Command {

    public void cmdCode(Interp interp, Thing[] argv) throws HeclException {
        String cmd = argv[0].getStringRep();
        if (cmd.equals("source")) {
            /* source a file */
            Eval.eval(interp, interp.getResAsThing(argv[1].toString()));
        }  else if (cmd.equals("sourcehere")) {
            /* source a file in a relative location */

...
/**
 * The <code>StringThing</code> class is the internal representation
 * of string types.  This is somewhat special, as all types in Hecl
...
public class StringThing implements RealThing {
    ...
    /**
     * Creates a new <code>StringThing</code> instance from a
     * stringbuffer.
     *
     * @param s a <code>String</code> value
     */
    ...
    /**
     * The <code>setStringFromAny</code> method transforms the Thing
     * into a string type.
     *
    ...
    /**
     * <code>get</code> returns a string representation of a given
     * Thing, transforming the thing into a string type at the same
     * time.
     *
     * @param thing a <code>Thing</code> value
    ...
    /**
     * <code>toString</code> returns its internal value.
     *
     * @return a <code>String</code> value
     */
    ...
    /**
     * <code>append</code> takes a character and appends it to the
     * string.
     *

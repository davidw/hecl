...
/**
 * The <code>GroupThing</code> class is for Hecl "groups".  For
 * instance, "foo $foo [foo]" must have its components kept together,
 * and is not a proper list.
 *
...
public class GroupThing implements RealThing {
    ...
    /**
     * <code>setGroupFromAny</code> creates a group from another type
     * of Thing.
     *
    ...
    /**
     * <code>get</code> returns a Vector containing other Things,
     * representing a group, from a Thing.
     *
     * @param thing a <code>Thing</code> value

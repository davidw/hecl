...
/**
 * <code>ReadCmd</code> implements the "readall" command.
 *
...
class ReadCmd implements Command {
    ...
    /**
     * The <code>cmdCode</code> method implements the standard cmdCode
     * interface, to create the 'readall' command.
     *
